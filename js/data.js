...
// =============================================================
// SPONSORS（スポンサー契約）
// Cookie Clickerの「建物」に相当。何件でも契約できる。
// baseIncome: 1契約あたりの円/秒
// baseCost: 1件目のコスト。N件目 = baseCost * 1.15^(N-1)
// followersRequired: 必要フォロワー数（通過しないと表示されない）
// =============================================================
...
const SPONSORS = [
  ...
  },
  {
    ...
    name: 'ホテルチェーン',
    emoji: '🏨',
    description: '宿泊レビューで安定収入',
    baseIncome: 500,
    baseCost: 14000,
    followersRequired: 10000,
  },
  {
    id: 'airline',
    name: '航空会社スポンサー',
    emoji: '✈️',
    description: 'ビジネスクラス無料＋報酬',
    baseIncome: 4000,
    baseCost: 150000,
  ...
  },
  {
    ...
    name: '大手旅行会社',
    emoji: '🌐',
    description: '専属トラベラー契約',
    baseIncome: 30000,
    baseCost: 1600000,
    followersRequired: 1000000,
  },
  {
    id: 'space_agency',
    name: '宇宙機関スポンサー',
    emoji: '🚀',
    description: 'NASAから宇宙探検の依頼',
    baseIncome: 250000,
    baseCost: 18000000,
    followersRequired: 10000000,
  },
  {
    id: 'galactic_corp',
    name: '銀河連邦スポンサー',
    emoji: '🌌',
    description: '宇宙文明に認められた旅人',
    baseIncome: 2000000,
    baseCost: 2e8,
    followersRequired: 1e8,
  },
];
